...
ActiveRecord::Schema.define(version: 20161203145835) do

  create_table "gathering_entries", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.boolean  "going"
    t.boolean  "paid"
    t.date     "pay_date"
    t.integer  "user_id"
    ...
    t.index ["user_id"], name: "index_gathering_entries_on_user_id", using: :btree
  end
  ...
  add_foreign_key "gathering_entries", "users"
